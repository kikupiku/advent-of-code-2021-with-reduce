...
const [gammaBinary, epsilonBinary] = diagnosticReport.reduce((accArr, current, i, arr) => {
  return current.reduce((accArr, current, index, array) => {
    return getDecodedColumnOfData(arr, index);
  }, [0, 0])
}, [0, 0]);
